...
<html lang="en">
<head>
	<title>Istana Helmet-Kontak</title>
	<meta charset="UTF-8">
...
<body class="animsition">
	...
	<!-- Title Page -->
	<section class="bg-title-page flex-c-m p-t-160 p-b-80 p-l-15 p-r-15" style="background-image: url(img/is.jpg);">
	...
	<section class="section-contact bg1-pattern p-t-90 p-b-113">
        ...
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.684131824834!2d107.59798791477287!3d-6.928307594994147!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68e620791df9bb%3A0x6a1f97cf7f4c61c9!2sIstana+Helmet!5e0!3m2!1sid!2sid!4v1539856070133" width="1350" height="600" frameborder="0" style="border:0" allowfullscreen></iframe>
        
			<div class="row p-t-135">
				<div class="col-sm-8 col-md-4 col-lg-4 m-l-r-auto p-t-30">
					<div class="dis-flex m-l-23">
						<div class="p-r-40 p-t-6">
							<img src="{{asset('asets/images/icons/map-icon.png')}}" alt="IMG-ICON">
						</div>
				...
				<div class="col-sm-8 col-md-3 col-lg-4 m-l-r-auto p-t-30">
					<div class="dis-flex m-l-23">
						<div class="p-r-40 p-t-6">
							<img src="{{asset('asets/images/icons/phone-icon.png')}}" alt="IMG-ICON">
						</div>
				...
				<div class="col-sm-8 col-md-5 col-lg-4 m-l-r-auto p-t-30">
					<div class="dis-flex m-l-23">
						<div class="p-r-40 p-t-6">
							<img src="{{asset('asets/images/icons/clock-icon.png')}}" alt="IMG-ICON">
						</div>
...
<!--===============================================================================================-->
	...
	<script src="{{asset('asets/js/map-custom.js')}}"></script>
<!--===============================================================================================-->
